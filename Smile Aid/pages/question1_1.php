                ...
                <form method="post" action="">
                    <div class="welcome">
                        ...
                        <?php 
                            ...
                            $q="SELECT *  from tbl_question where question_id=2";
                        ...
                        ?>
                            ...
                            <div class="left-ques">
                                ...
                                <?php 
                                    ...
                                    {
                                        ?>
                                        <img src="<?php echo SITEURL; ?>admin/pages/<?php echo $image_name; ?>" alt="beyond boundaries" />
                                        <?php
                                    }
                                ?>
...
if($user_answer==1){
header('location:'.SITEURL.'index.php?page=f1');
}
else if($user_answer==2){
header('location:'.SITEURL.'index.php?page=f2');

}
else if($user_answer==3){
header('location:'.SITEURL.'index.php?page=f3');
}
else{
header('location:'.SITEURL.'index.php?page=f4');
}
}
