                ...
                <form method="post" action="">
                    <div class="welcome">
                        ...
                        <?php 
                            ...
                            $q="SELECT *  from tbl_question where question_id=5";
...
if($user_answer==1){
header('location:'.SITEURL.'index.php?page=f13');
}
else if($user_answer==2){
header('location:'.SITEURL.'index.php?page=f14');

}
else if($user_answer==3){
header('location:'.SITEURL.'index.php?page=f15');

}
else{
header('location:'.SITEURL.'index.php?page=f16');
