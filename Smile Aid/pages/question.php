                ...
                <form method="post" action="">
                    <div class="welcome">
                        ...
                        <?php 
                            ...
                            $q="SELECT *  from tbl_question where question_id=1";
...
if($user_answer==1){
header('location:'.SITEURL.'index.php?page=question1_1');}
else if($user_answer==2){
header('location:'.SITEURL.'index.php?page=question1_2');
}
else if($user_answer==3){
header('location:'.SITEURL.'index.php?page=question1_3');
}
else{
header('location:'.SITEURL.'index.php?page=question1_4');
}
}
