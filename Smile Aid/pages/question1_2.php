                ...
                <form method="post" action="">
                    <div class="welcome">
                        ...
                        <?php 
                            ...
                            $q="SELECT *  from tbl_question where question_id=3";
...
if($user_answer==1){
header('location:'.SITEURL.'index.php?page=f5');
}
else if($user_answer==2){
header('location:'.SITEURL.'index.php?page=f6');

}
else if($user_answer==3){
header('location:'.SITEURL.'index.php?page=f7');

}
else{
    header('location:'.SITEURL.'index.php?page=f8');
}
}
